...
Model ModelManager::LoadOBJModel(const std::string& filePath, Textura* textura)
{
	...
	Model model(vertexs, textureCoordinates, vertexNormal, textura);
	return model;
}
...
void ModelManager::InitializeModels()
{
	...
	std::vector<float> vertexs{ -0.5f, +0.5f, -0.5f, // 3
		+0.5f, +0.5f, -0.5f, // 2
		-0.5f, -0.5f, -0.5f, // 6
		+0.5f, -0.5f, -0.5f, // 7
		+0.5f, -0.5f, +0.5f, // 4
	...
	models = {
		LoadOBJModel("Assets/Models/troll.obj", new Textura("Assets/Textures/Troll.png", 0, GL_TEXTURE0)),
		LoadOBJModel("Assets/Models/rock.obj", new Textura("Assets/Textures/rock.png", 1, GL_TEXTURE1)),
		LoadOBJModel("Assets/Models/clank.obj", new Textura("Assets/Textures/clank.png", 2, GL_TEXTURE2)),				
		Model (vertexs, nullptr)			
	};
}
